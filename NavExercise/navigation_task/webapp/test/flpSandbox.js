		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "navigation_prj",
									"targetURL": "#navigationtask-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"navigationtask-display": {
								"semanticObject": "navigationtask",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=navigationtask",
									"url": sap.ui.require.toUrl("navigationtask")
								}
							}
						}
					}
