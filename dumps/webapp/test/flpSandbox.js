		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Show dumps info",
									"targetURL": "#dumpsShowdumps-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dumpsShowdumps-display": {
								"semanticObject": "dumpsShowdumps",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dumpsShow.dumps",
									"url": sap.ui.require.toUrl("dumpsShow/dumps")
								}
							}
						}
					}
