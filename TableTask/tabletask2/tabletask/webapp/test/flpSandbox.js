		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "tableTaskUi5",
									"targetURL": "#tableTasktabletask-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tableTasktabletask-display": {
								"semanticObject": "tableTasktabletask",
								"action": "display",
								"description": "A Fiori application. Table sap.ui.tableTable",
								"title": "tableTaskUi5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tableTask.tabletask",
									"url": sap.ui.require.toUrl("tableTask/tabletask")
								}
							}
						}
					}
