			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fileupload-display": {
								"semanticObject": "fileupload",
								"action": "display",
								"description": "A Fiori application. Upload file.",
								"title": "File upload",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fileupload",
									"url": sap.ui.require.toUrl("fileupload")
								}
							}
						}
					}
